...
model_params = {
    ...
    "mixtral:latest": "47B",
    "llama3.1:70b": "70.6B",
    "nemotron:latest" : "70.6B"
}

# Prompt para las solicitudes
prompt = "Why is the sky blue?"

# Lista para almacenar los resultados
results = []

# Función para enviar una solicitud al servidor Ollama y medir los tiempos usando requests
def request_generation(server_address, model_name, prompt):
    retries = 3
    for attempt in range(retries):
        try:
            # Preparar la solicitud en formato JSON
            request_data = {
                "model": model_name,
                "prompt": prompt,
                "stream": False
            ...
            # Hacer la solicitud POST usando requests
            ...
            if response.status_code == 200:
                ...
                # Guardar resultados en la lista, incluyendo todos los datos del JSON
...
df_results = df_results[['model', 'params', 'response_time', 'tokens_per_second']]
